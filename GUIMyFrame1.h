...
public:
	...
	MyButton(wxFlexGridSizer* fgSizer1, wxPanel* parent, wxPanel* displaypanel, wxGrid* EXIF, wxWindowID id, const wxBitmap& bitmap, wxString path_array = 'a') : wxBitmapButton(parent, -1, bitmap)
	{
